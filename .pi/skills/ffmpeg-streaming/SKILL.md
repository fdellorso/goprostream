...
description: Gestione del flusso video con FFmpeg: conversione UDP→RTMP, diagnostica stream, test di connettività con la GoPro. Usa quando serve verificare, testare o modificare il pipeline di streaming.
---
